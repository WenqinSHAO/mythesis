...
First, moments of important changes in RTT measurements can serve as trigger for route re-selection, argued in this chapter.
Second, it helps group RTT time series undergoing same changes, covered by Chapter~\ref{sec:infer}.
...
Change detection methods, conceived for the robust yet sensitive detection of significant change in time series, is a competent tool for RTT measurement processing.
